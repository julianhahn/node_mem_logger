...
It'll add similar to this output, to the log every 10 seconds. 
```
=== Node.js Processes Check: 2025-01-17 18:40:23 ===
Frontend Process:
...
PID: 5674 | Memory: 727.00 MB | CPU: 2.2% | /vscode/vscode-server/bin/linux-x64/fabdb6a30b49f79a7aba0f2ad9df9b399473380f/node --dns-result-order=ipv4first /vscode/vscode-server/bin/linux-x64/fabdb6a30b49f79a7aba0f2ad9df9b399473380f/out/bootstrap-fork --type=extensionHost --transformURIs --useHostProxy=true
